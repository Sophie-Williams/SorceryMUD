CC = g++
OBJ = sorcery.o Request.o Response.o PlayerList.o NewCharList.o PlayerCharList.o NPCTypes.o NonPlayerCharList.o Room.o RoomList.o Server.o
...
NPCTypes.o: NPCTypes.cpp
	$(CC) $(FLAGS) -o NPCTypes.o -c NPCTypes.cpp
